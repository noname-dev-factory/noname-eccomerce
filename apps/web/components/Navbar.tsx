        ...
        <div className="navbar sticky top-0 z-50 bg-[#1d232a]">
            <div className="navbar-start">
                ...
                <ul className="menu menu-horizontal px-1 hidden lg:flex">
                    <li><Link href={"/"}>Home</Link></li>
                    <li tabIndex={0} className="flex flex-row rounded">
                        <Link className="pl-4 pr-2 rounded-none" href={"/products"}>Products</Link>
                        <details>
                            <summary className="pl-2 pr-5 h-full justify-self-center flex flex-column align-middle rounded-none">{" "}</summary>
                            <ul className="p-2">
                                <li><Link href={"/products/caps"}>Caps</Link></li>
                                <li><Link href={"/products/shirts"}>Shirts</Link></li>
                                <li><Link href={"/products/hoodies"}>Hoodies</Link></li>
            ...
            <div className="navbar-center">
                <Link className="btn btn-ghost text-xl font-bold uppercase" href={"/"}>noname</Link>
            </div>
            <div className="navbar-end">
                ...
                <button className="btn btn-ghost btn-circle text-center">
                    <div className="indicator justify-center">
                        ...
                        {empty
                            ? null
                            : <span className="badge badge-xs badge-primary indicator-item absolute right-1 "></span>
                        }
                    </div>
                </button>
            </div>
